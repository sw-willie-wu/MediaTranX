export default {
  ...
  image: {
    ...
    compress: {
      ...
      png_mode_lossless: '無損（保留品質）',
      jpeg_advanced: 'JPEG 選項',
      jpeg_progressive: '漸進式編碼',
      jpeg_keep_metadata: '保留中繼資料（EXIF）',
      webp_advanced: 'WebP 選項',
      webp_lossless: '無損編碼',
      task_label: '圖片 · 壓縮',
      saved: '已節省 {pct}%',
      larger: '增大 {pct}%',
  ...
  audio: {
    ...
    midi: {
      ...
      effects_eq_mid: '中頻',
      effects_eq_high: '高頻',
      effects_compressor: '壓縮器',
      effects_threshold: '閾值',
      effects_ratio: '比率',
      effects_delay: '延遲',
      effects_delay_time: '時間',
      effects_delay_feedback: '回授',
      effects_delay_wet: '混合',
      effects_reverb: '殘響',
      effects_reverb_decay: '衰減',
  ...
  settings: {
    ...
    general: {
      ...
      update: {
        ...
        install_now: '立即安裝',
        install_failed: '啟動安裝程式失敗',
        err: {
          network: '無法連線到更新伺服器',
          rate_limit: '檢查次數過多，請稍後再試',
          no_asset: '找不到安裝檔',
          generic: '檢查更新失敗',
        },
      },
