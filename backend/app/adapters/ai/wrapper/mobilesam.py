...
Inherits PackageWrapper, provides image object segmentation (for AI object removal).
"""
...
class MobileSAMWrapper(PackageWrapper):
    """
    MobileSAM object segmentation wrapper (inherits PackageWrapper).
    ...
    def _resolve_model_path(self, model_id: str, variant, manager):
        ...
        """
        model_path = manager.get_model_path(model_id, variant or "default")
        if not model_path:
